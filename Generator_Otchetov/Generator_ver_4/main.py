    ...
    def MENY(self):
        def clicked1():
            def clicked1_1():
                ...
                lbl5_CREAT = Label(window3, text="Вариант")
                lbl5_CREAT.grid(column=0, row=4)
                txt5_CREAT = Entry(window3, width=10)
                txt5_CREAT.grid(column=1, row=4)
                btn_CREAT = Button(window3, text="Потвердить", command=clicked1_CREAT)
                btn_CREAT.grid(column=0, row=5)
                window3.mainloop()
            def clicked1_2():
                global Inst
                Inst = ""
                ...
                lbl_OBZOR.grid(column=0, row=3)
            def clicked1_3():
                messagebox.showinfo('Обзор', 'Не реализовано!')
            def clicked1_4():
                messagebox.showinfo('Сохранить профиль', 'Не реализовано!')
            window2 = Tk()
            ...
            btn3 = Button(window2, text="Обзор", command=clicked1_3)
            btn3.grid(column=1, row=0)
            btn4 = Button(window2, text="Сохранить профиль", command=clicked1_4)
        ...
        def clicked2():
            ...
            def clicked1_2():
                global Predmet
                Predmet = "2"
                messagebox.showinfo('Предмет 2', 'Не реализовано!')
            def clicked1_3():
                global Predmet
                Predmet = "3"
                messagebox.showinfo('Предмет 3', 'Не реализовано!')
            window2 = Tk()
        ...
        def clicked3():
            ...
            pdf.ln(5)
            pdf.cell(200, 55, "Федеральное государственное бюджетное образовательное учреждение", align="C")
            pdf.ln(5)
        ...
        def clicked_meny_2():
            messagebox.showinfo('Авторы', 'Борисов «Moreez317» Александр и Чепелюк «Stoneby» Иван. Версия Генератора 0.4')
        def clicked4():
            messagebox.showinfo('Предпросмотр', 'Не реализовано!')
        def clicked5():
